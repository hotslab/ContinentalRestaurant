...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: 'booking', name: 'booking', component: () => import('src/pages/AuthenticatedPages/BookingPage.vue') },
      ...
      { path: 'user', name: 'user', component: () => import('src/pages/AuthenticatedPages/UserPage.vue') },
